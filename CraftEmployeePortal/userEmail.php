...
<div class="col-sm-12">
           ...
           <div class="form-group col-sm-8">
            ...
            <!-- <div class="wrapper-div">  -->     
                ...
                <form method="post" action="userEmail.php">
                   ...
                   <div class="col-sm-3"></div> <div class="col-sm-5"><input type="submit" href= "userEmail.php?id=.$id." name="submit" class="btn btn-primary btn-block" value="Submit" style="margin-top: 20px;"></div>
                </form>
            <!-- </div> -->
            </div>
          </div>
  ...
  <!-- <a  class='btn btn-danger' href=userList.php?id=".$id.">delete</a></td>"; -->
<!-- <?php 
